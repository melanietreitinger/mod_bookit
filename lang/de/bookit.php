...
$string['installation_heading'] = 'Fresh-Install-Baseline & Rollen-Presets';
$string['installation_heading_desc'] = 'Frische Installationen sollen beim Standalone-Kalender mit genau einem Default room, genau einem Default Weekplan, genau einer Standard-Institution und den mitgelieferten BookIt-Rollen-Presets enden.';
...
$string['institutionid_empty_notice'] = 'Es sind keine aktiven Institutionen vorhanden. Führen Sie zuerst die Fresh-Install-Baseline aus.';
...
$string['optional_plugin_parts_desc'] = 'Frische Installationen starten im reinen Kalender-Modus. Aktivieren Sie Ressourcen oder Checkliste hier nur dann, wenn Ihre Installation diese optionalen Plugin-Teile wirklich benötigt.';
...
$string['overview_rejected_requests_help'] = 'Zeigt abgelehnte Buchungsanfragen, bis der angefragte Termin fachlich vorbei ist oder die Anfrage wieder aktiviert wird.';
...
$string['roomid_empty_notice'] = 'Es sind keine aktiven Räume vorhanden. Führen Sie zuerst die Fresh-Install-Baseline aus.';
...
$string['runinstallhelper'] = 'Fresh-Install-Baseline anwenden und Rollen importieren';
$string['runinstallhelper_ready_state'] = 'Die Fresh-Install-Baseline ist bereits verifiziert. Sie können die Setup-Aktion erneut ausführen, um die mitgelieferten Rollen-Presets erneut zu prüfen.';
$string['runinstallhelper_result_failed'] = 'Die Fresh-Install-Einrichtung ist fehlgeschlagen. Importierte Rollen: {$a->rolesimported}; angelegte Baseline-Objekte: {$a->baselinecreated}; Verifikationsfehler: {$a->errors}.';
$string['runinstallhelper_result_idempotent'] = 'Die Fresh-Install-Einrichtung entspricht bereits dem Sollzustand. Beibehaltene Rollen-Presets: {$a->rolesskipped}; verifizierte Baseline-Objekte: {$a->baselineverified}.';
$string['runinstallhelper_result_partial'] = 'Die Fresh-Install-Einrichtung wurde nur teilweise abgeschlossen. Importierte Rollen: {$a->rolesimported}; beibehaltene Presets: {$a->rolesskipped}; angelegte Baseline-Objekte: {$a->baselinecreated}; verifizierte Baseline-Objekte: {$a->baselineverified}; Fehler: {$a->errors}.';
$string['runinstallhelper_result_success'] = 'Die Fresh-Install-Einrichtung wurde erfolgreich abgeschlossen. Importierte Rollen: {$a->rolesimported}; angelegte Baseline-Objekte: {$a->baselinecreated}.';
$string['runinstallhelperinfo'] = 'Führt die Standalone-Kalender-Einrichtung erneut aus: genau ein Default room, genau ein Default Weekplan (Mo-Fr 09:00-17:00), genau eine Standard-Institution und die mitgelieferten BookIt-Rollen-Presets. Es werden keine Checklisten-, Ressourcen-, Nutzer-, Kurs- oder Demo-Termin-Beispieldaten angelegt.';
