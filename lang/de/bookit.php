...
$string['blocker_add'] = 'Blocker hinzufügen';
$string['blocker_edit'] = 'Blocker bearbeiten';
$string['blocker_end'] = 'Ende';
$string['blocker_globally'] = 'Global';
$string['blocker_start'] = 'Anfang';
...
$string['bookingstatus_body_default_canceled'] = 'Vielen Dank für Ihre Anfrage "###EVENTNAME###" für ###BOOKINGDATE###. Leider müssen wir die Anfrage aufgrund bestimmter Umstände ablehnen.';
$string['bookingstatus_body_default_confirmed'] = 'Vielen Dank für Ihre Anfrage "###EVENTNAME###" für ###BOOKINGDATE###. Gerne bestätigen wir Ihre Buchung.';
$string['bookingstatus_body_default_inprogress'] = 'Vielen Dank für Ihre Anfrage "###EVENTNAME###" für ###BOOKINGDATE###. Einige Ressourcen werden noch geprüft, Sie werden in Kürze benachrichtigt.';
$string['bookingstatus_body_default_new'] = 'Vielen Dank für Ihre Buchungsanfrage "###EVENTNAME###" für ###BOOKINGDATE###. Wir haben Ihre Anfrage erhalten und prüfen sie in Kürze.';
$string['bookingstatus_body_default_rejected'] = 'Vielen Dank für Ihre Anfrage "###EVENTNAME###" für ###BOOKINGDATE###. Leider müssen wir die Anfrage aufgrund bestimmter Umstände ablehnen.';
$string['bookingstatus_body_desc'] = 'Unterstützte Platzhalter: ###EVENTNAME### und ###BOOKINGDATE###. Weitere unterstützte Platzhalter: ###BOOKINGSTATUS###, ###OLDBOOKINGSTATUS###, ###EVENTURL###, ###ROOM###, ###STARTTIME###, ###ENDTIME###, ###BOOKINGPERSON###, ###PERSONINCHARGE###, ###OTHEREXAMINERS###.';
...
$string['bookingstatus_enabled_canceled'] = 'Nachricht für Storniert senden';
$string['bookingstatus_enabled_confirmed'] = 'Nachricht für Bestätigt senden';
$string['bookingstatus_enabled_inprogress'] = 'Nachricht für In Bearbeitung senden';
$string['bookingstatus_enabled_new'] = 'Nachricht für Neu senden';
$string['bookingstatus_enabled_rejected'] = 'Nachricht für Abgelehnt senden';
...
$string['bookingstatus_notification_closing'] = "Freundliche Grüße\nIhr BookIt-Team";
$string['bookingstatus_notification_greeting'] = 'Guten Tag,';
$string['bookingstatus_notifications_desc'] = 'Empfänger und Nachrichtenvorlagen für Änderungen am Buchungsstatus konfigurieren.';
...
$string['bookingstatus_notify_serviceteam_desc'] = 'Sendet Statusänderungen an User mit der Rolle "Service-Team"';
$string['bookingstatus_service_addresses'] = 'Service-Adressen für Buchungsanfragen';
$string['bookingstatus_service_addresses_desc'] = 'E-Mail-Adressen, die Statusänderungen zusätzlich zu den Service-Team-Nutzern erhalten sollen (getrennt durch Komma, Semikolon oder Leerzeichen).';
...
$string['bookingstatus_subject_desc'] = 'Unterstützte Platzhalter: ###EVENTNAME###, ###BOOKINGDATE###, ###BOOKINGSTATUS###, ###OLDBOOKINGSTATUS###, ###EVENTURL###, ###ROOM###, ###STARTTIME###, ###ENDTIME###, ###BOOKINGPERSON###, ###PERSONINCHARGE###, ###OTHEREXAMINERS###.';
...
$string['bookit:addevent'] = 'Event hinzufügen';
...
$string['calendar_optional_fields'] = 'Optionale Felder';
$string['calendar_optional_fields_desc'] = 'Wählen Sie optionale Felder aus, die im Buchungsforumular angezeigt werden.';
...
$string['checklist_due_after_event'] = 'Nach der Prüfung';
$string['checklist_due_before_event'] = 'Vor der Prüfung';
$string['checklist_due_noduedate'] = 'Kein Fälligkeitsdatum';
$string['checklist_duedate'] = 'Fälligkeitsdatum';
...
$string['checklist_duedate_help'] = "Das Fälligkeitsdatum für die Fertigstellung des Checklisten-Elements. Muss einer von 'none', 'before' oder 'after' der Prüfung sein. Ein Offset in Tagen muss gesetzt werden, wenn die Optionen 'before' oder 'after' ausgewählt werden.";
$string['checklist_responsibility'] = 'Verantwortlichkeit';
...
$string['event_error_mintime'] = 'Sie können keine Termine in der Vergangenheit anlegen.';
...
$string['event_extratime'] = '<i>Extra-Zeit für das Event</i>';
...
$string['event_past_participant_notice'] = 'Diese Buchung hat bereits begonnen und kann von Teilnehmenden nicht mehr geändert werden.';
...
$string['event_semester_summer'] = 'Sommersemester';
$string['event_semester_winter'] = 'Wintersemester';
$string['event_start'] = 'Beginn';
$string['event_start_help'] = 'Wählen Sie das Startdatum und -uhrzeit des Termins.';
$string['event_starttime'] = 'Startzeit';
...
$string['event_usermodified'] = 'Zuletzt geändert von';
...
$string['examiner_pool_usernames'] = 'Usernamen für den Prüfenden-Pool';
$string['examiner_pool_usernames_desc'] = 'Optionale kommagetrennte Liste von Moodle-Usernamen, die als verantwortliche Person oder weitere Prüfende ausgewählt werden dürfen. Leer lassen, um alle aktiven Nutzer zuzulassen.';
...
$string['institution_edit'] = 'Institution bearbeiten';
...
$string['messageprovider:bookit_booking_status_changed'] = 'Benachrichtigung bei Änderung des Buchungsstatus';
$string['messageprovider:bookit_resource_status_changed'] = 'Benachrichtigung bei Änderung des Ressourcenstatus';
...
$string['observer_export_denied'] = 'Der Event-Export ist für Ihre Rolle nicht verfügbar.';
...
$string['overview_workflow_history_empty'] = 'Es wurden noch keine Workflow-Einträge protokolliert.';
$string['overview_workflow_history_recovery'] = 'Die Wiederherstellung nutzt den letzten gültigen Workflow-Status.';
...
$string['room_data_edit'] = 'Raumdaten bearbeiten';
...
$string['room_edit'] = 'Raum bearbeiten';
$string['room_location'] = 'Ort';
$string['room_overlapping_mode'] = 'Soll Überschneidung von Terminen verhindert werden?';
$string['room_overwrite_extratimeafter'] = 'Globale extratimeafter-Einstellung überschreiben?';
$string['room_overwrite_extratimebefore'] = 'Globale extratimebefore-Einstellung überschreiben?';
$string['room_seats'] = 'Anzahl an Plätzen';
$string['room_shortname'] = 'Kurzname';
...
$string['runinstallhelper'] = 'Install Helper ausführen';
...
$string['settings_display_day'] = 'Tagesansicht';
$string['settings_display_heading'] = 'Kalenderanzeige pro Ansicht';
$string['settings_display_heading_desc'] = 'Legen Sie fest, wie Prüfungen in jeder Ansicht dargestellt werden. Noch nicht umgesetzte Modi sind als geplant markiert.';
$string['settings_display_month'] = 'Monatsansicht';
$string['settings_display_na'] = 'n. v.';
$string['settings_display_planned'] = 'geplant';
$string['settings_display_week'] = 'Wochenansicht';
...
$string['settings_eventmaxyear'] = 'Maximales Jahr für Eventauswahl';
...
$string['settings_eventminyear'] = 'Minimales Jahr für Eventauswahl';
...
$string['settings_layout_horizontal'] = 'Horizontal (Raster, nebeneinander)';
$string['settings_layout_label'] = 'Layout';
$string['settings_layout_vertical'] = 'Vertikal (Liste, eine Zeile pro Termin)';
...
$string['settings_overlap_label'] = 'Überlappende Termine';
$string['settings_overlap_overlapping'] = 'Überlappend (Standard)';
$string['settings_overlap_separated'] = 'Nebeneinander (abgegrenzt)';
...
$string['settings_slotdisplay_desc'] = 'Legt fest, ob der Kalender die aktuelle Darstellung verwendet oder buchbare Zeitfenster anhand der Wochenpläne und nicht verfügbare Zeiten anzeigt.';
...
$string['settings_summary_label'] = 'Zusammenfassung (Slot-Summen)';
$string['settings_summary_off'] = 'Aus — einzelne Prüfungen anzeigen';
$string['settings_summary_on'] = 'An — „N Prüfungen" pro Slot, Klick zum Ausklappen';
$string['settings_val_horizontal'] = 'horizontal';
$string['settings_val_overlapping'] = 'überlappend';
...
$string['weekplan_did_not_begin_with_weekday'] = 'Zeile beginnt nicht mit einem Wochentag';
$string['weekplan_edit'] = 'Wochenplan bearbeiten';
$string['weekplan_end_before_start'] = 'Der Endzeitpunkt muss nach dem Anfangszeitpunkt liegen!';
$string['weekplan_end_of_period'] = 'Ende des Zeitraums';
$string['weekplan_help'] = 'Der Wochenplan definiert die verfügbaren Zeitslots und Raumzuweisungen für dieses Semester.';
$string['weekplan_start_of_period'] = 'Anfang des Zeitraums';
