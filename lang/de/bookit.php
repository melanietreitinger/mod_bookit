...
$string['bookingstatus_body_language_de'] = 'Nachrichtentext (Deutsch)';
$string['bookingstatus_body_language_en'] = 'Nachrichtentext (Englisch)';
...
$string['bookingstatus_subject_language_de'] = 'Betreff (Deutsch)';
$string['bookingstatus_subject_language_en'] = 'Betreff (Englisch)';
...
$string['overview_request_workspace_help'] = 'Verwaltet offene und abgelehnte Buchungsanfragen in einem gemeinsamen BookIt-Workspace, ohne den Activity-Kontext zu verlassen.';
$string['overview_request_workspace_switch'] = 'Anfrage-Queues';
$string['overview_request_workspace_switch_help'] = 'Wechselt innerhalb desselben Anfrage-Workspaces zwischen offenen und abgelehnten Anfragen.';
