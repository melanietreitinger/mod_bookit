...
$string['event_error_weekplan_both'] = 'Der Termin von {$a->start}–{$a->end} kann nicht gespeichert werden: {$a->start} und {$a->end} liegen außerhalb aller verfügbaren Wochenplan-Slots.';$string['event_extratime'] = '<i>Extra-Zeit für das Event</i>';
