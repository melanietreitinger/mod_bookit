...
$string['bookingstatus_service_addresses_desc'] = 'Optional list of email addresses that should receive booking-status notifications (comma, semicolon, or whitespace separated).';
...
$string['installation_heading'] = 'Fresh-install baseline & role presets';
$string['installation_heading_desc'] = 'Fresh installs must stop at the standalone calendar baseline with one default room, one default weekplan, one default institution, and the shipped BookIt role presets.';
...
$string['institutionid_empty_notice'] = 'No active institutions are available. Run the fresh-install baseline action first.';
...
$string['optional_plugin_parts_desc'] = 'Fresh installs start in calendar-only mode. Enable resources or checklist here only when the installation really needs those optional plugin parts.';
...
$string['overview_open_requests_help'] = 'Shows all booking requests with status New or In Progress.';
...
$string['overview_rejected_requests_help'] = 'Shows rejected booking requests until the requested slot is over or the request is reactivated.';
...
$string['roomid_empty_notice'] = 'No active rooms are available. Run the fresh-install baseline action first.';
...
$string['runinstallhelper'] = 'Apply fresh-install baseline and import roles';
$string['runinstallhelper_ready_state'] = 'Fresh-install baseline already verified. You can rerun the setup action if you need to re-check the shipped role presets.';
$string['runinstallhelper_result_failed'] = 'Fresh-install setup failed. Imported roles: {$a->rolesimported}; baseline created: {$a->baselinecreated}; verification errors: {$a->errors}.';
$string['runinstallhelper_result_idempotent'] = 'Fresh-install setup is already in the expected state. Existing role presets kept: {$a->rolesskipped}; verified baseline items: {$a->baselineverified}.';
$string['runinstallhelper_result_partial'] = 'Fresh-install setup finished only partially. Imported roles: {$a->rolesimported}; kept presets: {$a->rolesskipped}; baseline created: {$a->baselinecreated}; verified baseline items: {$a->baselineverified}; errors: {$a->errors}.';
$string['runinstallhelper_result_success'] = 'Fresh-install setup completed successfully. Imported roles: {$a->rolesimported}; baseline items created: {$a->baselinecreated}.';
$string['runinstallhelperinfo'] = 'Runs the standalone calendar setup again: exactly one Default room, exactly one Default Weekplan (Mo-Fr 09:00-17:00), exactly one Standard-Institution, and the shipped BookIt role presets. No checklist, resource, user, course, or demo-event sample data is created.';
