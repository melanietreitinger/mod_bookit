...
$string['bookingstatus_body_language_de'] = 'Message body (German)';
$string['bookingstatus_body_language_en'] = 'Message body (English)';
...
$string['bookingstatus_subject_language_de'] = 'Message subject (German)';
$string['bookingstatus_subject_language_en'] = 'Message subject (English)';
...
$string['overview_request_workspace_help'] = 'Manage open and rejected booking requests inside one shared BookIt workspace without leaving the activity context.';
$string['overview_request_workspace_switch'] = 'Request queues';
$string['overview_request_workspace_switch_help'] = 'Switch between open and rejected requests inside the same request workspace.';
