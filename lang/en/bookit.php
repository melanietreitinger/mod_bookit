...
$string['bookingstatus_action_accept'] = 'Accept';
$string['bookingstatus_action_cancel'] = 'Cancel';
$string['bookingstatus_action_inprogress'] = 'Set in progress';
$string['bookingstatus_action_reactivate'] = 'Reactivate as new request';
$string['bookingstatus_action_reject'] = 'Reject';
$string['bookingstatus_body_accepted'] = 'Message body for Confirmed';
$string['bookingstatus_body_canceled'] = 'Message body for Canceled';
$string['bookingstatus_body_default_accepted'] = 'Thank you for your request "###EVENTNAME###" for ###BOOKINGDATE###. We are pleased to confirm your booking.';
...
$string['bookingstatus_body_desc'] = 'Supported business placeholders: ###EVENTNAME### and ###BOOKINGDATE###. Existing older templates may continue to use legacy placeholders.';
...
$string['bookingstatus_enabled_accepted'] = 'Send message for Confirmed';
...
$string['bookingstatus_notify_serviceteam_desc'] = 'Send booking-status messages to users who have the service-team capability in this BookIt activity.';
$string['bookingstatus_service_addresses'] = 'University service addresses';
$string['bookingstatus_service_addresses_desc'] = 'Optional shared service addresses that should receive booking-status notifications in addition to the service-team users (comma, semicolon, or whitespace separated).';
$string['bookingstatus_service_recipient_firstname'] = 'University';
$string['bookingstatus_service_recipient_lastname'] = 'Service';
$string['bookingstatus_subject_accepted'] = 'Message subject for Confirmed';
$string['bookingstatus_subject_canceled'] = 'Message subject for Canceled';
$string['bookingstatus_subject_default_accepted'] = 'Booking request confirmed: ###EVENTNAME### on ###BOOKINGDATE###';
...
$string['bookingstatus_subject_desc'] = 'Supported business placeholders: ###EVENTNAME### and ###BOOKINGDATE###. Existing older templates may continue to use legacy placeholders.';
...
$string['calendar_optional_fields'] = 'Enabled optional calendar fields';
$string['calendar_optional_fields_desc'] = 'Comma-separated list of optional fields that stay visible in the shared booking form profile. Supported keys: timecompensation, compensationfordisadvantages, notes, refcourseid, coursetemplate.';
...
$string['event_past_participant_close'] = 'Close';
...
$string['event_status_action_cancel_only'] = 'Cancel booking';
$string['event_status_action_close_modal'] = 'Keep booking';
...
$string['event_supportperson_internalnotes_notice'] = 'Support on site may edit only the internal notes field.';
...
$string['exportevents_selected'] = 'Selected';
...
$string['go'] = 'Apply';
$string['governedread_accessdenied'] = 'You do not have permission to load this read model.';
$string['governedread_calendar_empty'] = 'No bookings match the selected calendar filters.';
$string['governedread_overviewqueue_empty'] = 'No overview items match the selected filters.';
$string['governedread_roomavailability_empty'] = 'No room-availability entries match the selected period.';
$string['header_internal'] = 'Internal fields';
$string['history_action_accepted'] = 'Changed to Confirmed';
...
$string['observer_empty_state'] = 'No accepted bookings are currently available for your role.';
...
$string['overview_accepted_request_count'] = '{$a} accepted bookings';
$string['overview_accepted_requests'] = 'Accepted bookings';
$string['overview_accepted_requests_empty'] = 'There are currently no accepted bookings in the accepted workspace.';
$string['overview_accepted_requests_help'] = 'Shows accepted bookings that are still active and not yet in history.';
...
$string['overview_history_help'] = 'Shows bookings that already ended and match the selected filters.';
$string['overview_my_events'] = 'My booked events';
$string['overview_no_results'] = 'No bookings match the selected filters.';
$string['overview_open_request_count'] = '{$a} open requests';
...
$string['overview_rejected_request_count'] = '{$a} rejected or cancelled requests';
$string['overview_rejected_requests'] = 'Rejected and cancelled requests';
...
$string['overview_rejected_requests_help'] = 'Shows rejected requests and booker-cancelled bookings for service-team follow-up until a request is restored to New.';
...
$string['overview_request_workspace_switch_help'] = 'Switch between active open requests and the rejected-request trash inside the same request workspace.';
...
$string['rolepreset_bookingperson_desc'] = 'A person who makes a request for an e-examination (examiners, examination offices, student staff, academic staff, ...).';
...
$string['rolepreset_examiner_desc'] = 'A person who belongs to or is associated with a university and examines students.';
...
$string['rolepreset_observer_desc'] = 'A person who can only view events (e.g. room management, examination office, deanship, service team of another university).';
...
$string['rolepreset_serviceteam_desc'] = 'A person who works in the e-assessment service and manages exam bookings.';
...
$string['rolepreset_supportonsite_desc'] = 'A person who supports an exam on site.';
...
$string['rolepresethelp'] = 'Hover over the icon (i) to see the description of each role.';
$string['room'] = 'Room';
