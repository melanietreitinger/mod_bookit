...
$string['bookingstatus_subject_default_accepted'] = 'Booking request accepted: ###EVENTNAME### on ###BOOKINGDATE###';
...
$string['history_action_accepted'] = 'Accepted';
...
$string['resources:status_requested'] = 'new';
