...
$string['calendar_collapsegroups'] = 'Collapse';
$string['calendar_editevent'] = "Edit event";
$string['calendar_eventlist'] = 'List';
$string['calendar_moreevents'] = '+{$a} more';
...
$string['calendar_summary_count'] = '{$a} exams';
...
$string['exportevents_ics_directlink'] = 'Direct link to booking request';
...
$string['settings_display_day'] = 'Day view';
$string['settings_display_heading'] = 'Calendar display per view';
$string['settings_display_heading_desc'] = 'Choose how exams are shown in each view. Modes that are not built yet are marked as planned.';
$string['settings_display_month'] = 'Month view';
$string['settings_display_na'] = 'n/a';
$string['settings_display_planned'] = 'planned';
$string['settings_display_week'] = 'Week view';
...
$string['settings_eventyear_current'] = 'Current year';
$string['settings_eventyear_minus1'] = '-1 year';
$string['settings_eventyear_minus2'] = '-2 years';
$string['settings_eventyear_plus1'] = '+1 year';
$string['settings_eventyear_plus2'] = '+2 years';
...
$string['settings_layout_horizontal'] = 'Horizontal (grid, side by side)';
$string['settings_layout_label'] = 'Layout';
$string['settings_layout_vertical'] = 'Vertical (list, one row per event)';
...
$string['settings_maxevents_label'] = 'Max. events per slot (0 = off)';
$string['settings_overlap_label'] = 'Overlapping events';
$string['settings_overlap_overlapping'] = 'Overlapping (default)';
$string['settings_overlap_separated'] = 'Side by side (no overlap)';
...
$string['settings_slotdisplay_current'] = 'Current calendar display';
$string['settings_slotdisplay_desc'] = 'Choose whether the calendar uses the current display or shows weekplan-based bookable slots and unavailable times.';
$string['settings_slotdisplay_label'] = 'Calendar slot display';
$string['settings_slotdisplay_weekplans'] = 'Show weekplan slots and unavailable times';
$string['settings_summary_hover'] = 'On — show "N exams" per slot, details on hover';
$string['settings_summary_label'] = 'Summary view (slot totals)';
$string['settings_summary_off'] = 'Off — show individual exams';
$string['settings_summary_on'] = 'On — show "N exams" per slot, click to expand';
$string['settings_val_horizontal'] = 'horizontal';
$string['settings_val_overlapping'] = 'overlapping';
$string['settings_val_separated'] = 'side by side';
$string['settings_val_vertical'] = 'vertikal';
$string['settings_vertical_label'] = 'Vertical (stacked) display';
