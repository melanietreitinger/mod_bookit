...
$string['ressource_before_due'] = 'Before due';
$string['ressource_overdue'] = 'Reminder when overdue';
$string['ressource_when_done'] = 'When done';
$string['ressource_when_due'] = 'When due';
$string['role'] = 'Role';
