...
$string['event_error_weekplan_both'] = 'Cannot save event from {$a->start}–{$a->end}: {$a->start} and {$a->end} are outside of any available weekplan slot.';$string['event_extratime'] = '<i>Extra time for the event</i>';
