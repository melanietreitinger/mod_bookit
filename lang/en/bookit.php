...
$string['runinstallhelperinfo'] = 'If you have just installed the plugin, you can run the install helper once to create default BookIt roles and example checklist data. Otherwise you need to import the roles manually from the provided files in the plugin directory.W';
