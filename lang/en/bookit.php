...
$string['bookingstatus_subject_desc'] = 'Supported placeholders include ###EVENTNAME### and ###BOOKINGDATE###. Additional supported placeholders: ###BOOKINGSTATUS###, ###OLDBOOKINGSTATUS###, ###EVENTURL###, ###ROOM###, ###STARTTIME###, ###ENDTIME###, ###BOOKINGPERSON###, ###PERSONINCHARGE###, ###OTHEREXAMINERS###.';
