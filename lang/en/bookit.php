...
$string['pdf_method'] = 'PDF generation method';
$string['pdf_from_html'] = 'From HTML (client-side rendering)';
$string['pdf_from_data'] = 'From data (server-side PDF)';
$string['pdf_method_help'] = 'Choose how the PDF should be generated:<br>• <strong>From HTML</strong>: Renders the current page view as PDF (includes visual formatting and colors)<br>• <strong>From data</strong>: Generates PDF from checklist data using server templates (more reliable, consistent formatting)';
