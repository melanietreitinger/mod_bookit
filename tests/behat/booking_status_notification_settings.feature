...
Feature: Manage booking status notification settings
  ...
  Scenario: Admin sees the concise intro and prefilled expressive templates
    ...
    And the field "Message subject for Accepted" matches value "Booking request accepted: ###EVENTNAME### on ###BOOKINGDATE###"
    And the Bookit editor field "Message body for Accepted" should equal "Thank you for your request ""###EVENTNAME###"" for ###BOOKINGDATE###. We are pleased to confirm your booking."
