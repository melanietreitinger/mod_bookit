...
Feature: Keep calendar and overview visibility aligned
  ...
  Scenario: Support person sees new, in-progress and confirmed bookings across calendar and overview
    ...
    And the Bookit calendar projection for user "supportuser" in "My BookIt Activity" from "tomorrow 00:00" to "tomorrow 23:59" should contain "Hidden support exam"
    ...
    And I should see "Hidden support exam"
