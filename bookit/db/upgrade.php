...
/**
 * Executes mod_bookit upgrade steps.
 *
...
function xmldb_bookit_upgrade(int $oldversion): bool {
    ...
    if ($oldversion < 2024102204) {
        ...
        // Define table object once.
        $table = new xmldb_table('bookit_event');

        /* Rename field status → bookingstatus. */
        $field1 = new xmldb_field('status', XMLDB_TYPE_INTEGER, '6',
        ...
        /* Add new fields. */
        $field4 = new xmldb_field('timecompensation', XMLDB_TYPE_INTEGER, '1',
                                  null, null, null, null, 'participantsamount');
        $dbman->add_field($table, $field4);

        $field5 = new xmldb_field('otherexaminers', XMLDB_TYPE_TEXT, null,
                                  null, null, null, null, 'personinchargeid');
        $dbman->add_field($table, $field5);

        /* Rename table bookit_category → bookit_resource_categories. */
